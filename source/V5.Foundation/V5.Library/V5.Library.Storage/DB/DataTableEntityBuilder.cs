namespace V5.Library.Storage.DB
{
	...
	public class DataTableEntityBuilder<Entity>
	{
		...
		public static DataTableEntityBuilder<Entity> CreateBuilder(DataRow dataRecord)
		{
			...
			{
                PropertyInfo propertyInfo = typeof(Entity).GetProperty(dataRecord.Table.Columns[i].ColumnName, BindingFlags.Public | BindingFlags.Instance | BindingFlags.IgnoreCase);
