...
{  
    ...
    {  
        ...
        public static bool CheckBadStr(object[] args)  
        {  
            string[] Lawlesses = { "'", ";", ":", "%", "@", "&", "#", "\"", "net user", "exec", "net localgroup", "select", "asc", "char", "mid", "insert", "order", "exec", "delete", "drop", "truncate", "xp_cmdshell", "<", ">" };
