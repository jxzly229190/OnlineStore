// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Product.SoldOut.cs" company="www.gjw.com">
...
namespace V5.Portal.Backstage.Controllers.Product
{
    ...
    public partial class ProductController
    {
        ...
        /// </returns>
        public ActionResult QueryProductSoldOut([DataSourceRequest] DataSourceRequest request, string productName, string barcode, string parentCategoryID, string productCategoryID, string parentBrandID, string productBrandID, string minPrice, string maxPrice)
        {
            int totalCount;

            var stringBuilder = new StringBuilder();
            stringBuilder.Append("[Status] in (1,3)");
        ...
        /// The <see cref="ActionResult"/>.
        /// </returns>
        public ActionResult PutShelf(string productID)
        {
            AjaxResponse ajaxResponse;

            try
            {
                this.ProductService.ModifyProductStatus(productID, 2);
