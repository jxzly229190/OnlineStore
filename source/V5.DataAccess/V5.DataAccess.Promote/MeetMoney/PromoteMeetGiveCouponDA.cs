// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PromoteMeetGiveCouponDA.cs" company="www.gjw.com">
...
namespace V5.DataAccess.Promote.MeetMoney
{
    ...
    /// 满足条件送优惠券促销规则数据访问类.
    /// </summary>
    public class PromoteMeetGiveCouponDA : IPromoteMeetGiveCouponDA
    {
        ...
        public void Delete(int id, SqlTransaction transaction)
        {
            ...
            this.SqlServer.ExecuteNonQuery(
                ...
                "sp_Promote_Meet_GiveCoupon_DeleteRow",
                parameters,
                transaction);
        }
        ...
        public void DeleteByRuleID(int ruleID, SqlTransaction transaction)
        {
            ...
            this.SqlServer.ExecuteNonQuery(
                CommandType.StoredProcedure,
                "sp_Promote_Meet_GiveCoupon_Delete",
                parameters,
                transaction);
        }
        ...
        public bool IsExist(int ruleID, SqlTransaction transaction)
        {
            ...
            var dataReader = this.SqlServer.ExecuteDataReader(
                CommandType.StoredProcedure,
                "sp_Promote_Meet_GiveCoupon_Select",
                parameters,
                transaction);
