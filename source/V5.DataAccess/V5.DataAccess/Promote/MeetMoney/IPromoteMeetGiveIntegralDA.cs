// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IPromoteMeetGiveIntegralDA.cs" company="www.gjw.com">
...
namespace V5.DataAccess.Promote.MeetMoney
{
    ...
    /// 满足条件送积分促销规则数据访问接口.
    /// </summary>
    public interface IPromoteMeetGiveIntegralDA
    {
        ...
        /// 满足条件送积分促销规则编号.
        /// </returns>
        int Insert(Promote_Meet_GiveIntegral promoteMeetGiveIntegral, SqlTransaction transaction);
        ...
        /// 数据事务.
        /// </param>
        void UpdateByRuleID(Promote_Meet_GiveIntegral promoteMeetGiveIntegral, SqlTransaction transaction);
